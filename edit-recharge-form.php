...
$id = $_GET["id"];
    $result = $mysqli->prepare("SELECT * FROM recharge WHERE id= ? ");
...
<body class="bg-gray-100 text-gray-800">
  ...
  <section class="py-12 px-4 pt-32">
    <div class="max-w-md mx-auto bg-white p-6 rounded-xl shadow-lg">
      ...
      <form action="edit-recharge-manager.php" method="POST" class="space-y-4 text-sm">
        <div>
          <label for="name" class="block mb-1 text-gray-700 font-medium">Customer Name</label>
          <input type="text" id="user" name="user" value="<?php echo $row['user']?>" placeholder="Enter full name"
